...
import { faMagnifyingGlass , faBagShopping , faUserCircle } from '@fortawesome/free-solid-svg-icons';
...
const SearchHeaderForm = () => {
  return (
    ...
    <InputGroup className="">
        ...
        />
        <Button className="border border-start-0" variant="outline-secondary" id="button-addon2">
